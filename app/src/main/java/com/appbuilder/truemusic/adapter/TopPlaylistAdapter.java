...
public class TopPlaylistAdapter extends RecyclerView.Adapter<TopPlaylistAdapter.CustomerViewHolder> {

    private Context mContext;
    private List<TopPlaylist> mList;
    private CustomOnItemClickListener<TopPlaylist> customOnItemClickListener;

    public TopPlaylistAdapter(Context context, List<TopPlaylist> list) {
        mContext = context;
        mList = list;
    }
    ...
    public void onBindViewHolder(CustomerViewHolder holder, int position) {
        final TopPlaylist item = mList.get(position);
    ...
    public void setCustomOnItemClickListener(CustomOnItemClickListener<TopPlaylist> customOnItemClickListener) {
